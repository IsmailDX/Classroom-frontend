        ...
        <DataTableFilterInput
            ...
            renderInput={({ value, onChange }) => (
                <Input
                    ...
                    placeholder={
                        placeholder ??
                        t('table.filter.text.placeholder', 'Filter by...')
                    }
                    value={value}
                    onChange={(event) => {
        ...
        <DataTableFilterInput
            ...
            renderInput={({ value, onChange }) => (
                <Input
                    ...
                    placeholder={
                        placeholder ??
                        t('table.filter.numeric.placeholder', 'Filter by...')
                    }
                    value={value}
                    onChange={(event) => {
                        onChange(event.target.value)
